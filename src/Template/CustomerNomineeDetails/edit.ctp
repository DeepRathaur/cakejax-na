...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $customerNomineeDetail->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $customerNomineeDetail->id)]
            )
        ?></li>
...
<div class="customerNomineeDetails form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Customer Nominee Detail') ?></legend>
        <?php
