...
<div class="states view large-9 medium-8 columns content">
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($state->admins as $admins): ?>
            <tr>
                <td><?= h($admins->id) ?></td>
    ...
    <div class="related">
        ...
        <?php if (!empty($state->crop_insurance_offline_calculators)): ?>
        <table cellpadding="0" cellspacing="0">
            <tr>
                <th scope="col"><?= __('Id') ?></th>
                <th scope="col"><?= __('State Id') ?></th>
            ...
            <?php foreach ($state->crop_insurance_offline_calculators as $cropInsuranceOfflineCalculators): ?>
            <tr>
    ...
    <div class="related">
        ...
        <?php if (!empty($state->customer_contact_details)): ?>
        <table cellpadding="0" cellspacing="0">
            <tr>
                <th scope="col"><?= __('Id') ?></th>
            ...
            <?php foreach ($state->customer_contact_details as $customerContactDetails): ?>
            <tr>
    ...
    <div class="related">
        ...
        <?php if (!empty($state->customer_land_hold_details)): ?>
        <table cellpadding="0" cellspacing="0">
            <tr>
                <th scope="col"><?= __('Id') ?></th>
                <th scope="col"><?= __('Customer Id') ?></th>
            ...
            <?php foreach ($state->customer_land_hold_details as $customerLandHoldDetails): ?>
            <tr>
    ...
    <div class="related">
        <h4><?= __('Related Rto City Masters') ?></h4>
        <?php if (!empty($state->rto_city_masters)): ?>
        <table cellpadding="0" cellspacing="0">
            <tr>
                <th scope="col"><?= __('Id') ?></th>
                ...
                <th scope="col"><?= __('Alias Region Code') ?></th>
                <th scope="col"><?= __('Name') ?></th>
                <th scope="col"><?= __('Created') ?></th>
                <th scope="col"><?= __('Modified') ?></th>
                <th scope="col" class="actions"><?= __('Actions') ?></th>
            </tr>
            <?php foreach ($state->rto_city_masters as $rtoCityMasters): ?>
            <tr>
                <td><?= h($rtoCityMasters->id) ?></td>
                <td><?= h($rtoCityMasters->city_name) ?></td>
                <td><?= h($rtoCityMasters->state_id) ?></td>
                <td><?= h($rtoCityMasters->region_code) ?></td>
                <td><?= h($rtoCityMasters->alias_region_code) ?></td>
                <td><?= h($rtoCityMasters->name) ?></td>
                <td><?= h($rtoCityMasters->created) ?></td>
                <td><?= h($rtoCityMasters->modified) ?></td>
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['controller' => 'RtoCityMasters', 'action' => 'view', $rtoCityMasters->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['controller' => 'RtoCityMasters', 'action' => 'edit', $rtoCityMasters->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['controller' => 'RtoCityMasters', 'action' => 'delete', $rtoCityMasters->id], ['confirm' => __('Are you sure you want to delete # {0}?', $rtoCityMasters->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </table>
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($state->schemes as $schemes): ?>
            <tr>
                <td><?= h($schemes->id) ?></td>
