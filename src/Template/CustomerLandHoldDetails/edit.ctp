...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $customerLandHoldDetail->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $customerLandHoldDetail->id)]
            )
        ?></li>
...
<div class="customerLandHoldDetails form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Customer Land Hold Detail') ?></legend>
        <?php
