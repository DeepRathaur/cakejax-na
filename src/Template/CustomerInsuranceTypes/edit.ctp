...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $customerInsuranceType->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $customerInsuranceType->id)]
            )
        ?></li>
...
<div class="customerInsuranceTypes form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Customer Insurance Type') ?></legend>
        <?php
