...
class StatesController extends AppController
{
    ...
    public function view($id = null)
    {
        $state = $this->States->get($id, [
            'contain' => ['Zones', 'Admins', 'CropInsuranceOfflineCalculators', 'CustomerContactDetails', 'CustomerLandHoldDetails', 'Customers', 'Districts', 'RtoCityMasters', 'Schemes', 'Users']
        ]);
    ...
    public function add()
    {
        ...
        $zones = $this->States->Zones->find('list', ['limit' => 200]);
        $this->set(compact('state', 'zones'));
    }
