...
class DistrictsController extends AppController
{
    ...
    public function view($id = null)
    {
        $district = $this->Districts->get($id, [
            'contain' => ['Zones', 'States', 'Admins', 'CropInsuranceOfflineCalculators', 'CustomerContactDetails', 'CustomerLandHoldDetails', 'Customers', 'Schemes', 'Users']
        ]);
    ...
    public function add()
    {
        ...
        $this->set(compact('district', 'zones', 'states'));
    }
