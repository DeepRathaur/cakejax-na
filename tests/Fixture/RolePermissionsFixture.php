...
class RolePermissionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'role_permissions_ibfk_1' => ['type' => 'foreign', 'columns' => ['role_id'], 'references' => ['roles', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'role_id' => 1,
                'permission_id' => 1,
                'created' => '2018-05-05 05:19:05',
                'modified' => '2018-05-05 05:19:05'
            ],
        ];
        parent::init();
    }
